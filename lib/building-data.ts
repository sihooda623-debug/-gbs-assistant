...
export const FLOORS: Record<number, Room[]> = {
  ...
  3: [
    ...
    { id: "3_컴퓨터실1", name: "컴퓨터실Ⅰ", floor: 3, building: "본관", col: 0, row: 6, width: 2, height: 1, type: "classroom" },
    { id: "3_컴퓨터실2", name: "컴퓨터실Ⅱ", floor: 3, building: "본관", col: 2, row: 6, width: 2, height: 1, type: "classroom" },
    { id: "3_교육정보부", name: "교육정보부", floor: 3, building: "본관", col: 4, row: 6, width: 2, height: 1, type: "office" },
